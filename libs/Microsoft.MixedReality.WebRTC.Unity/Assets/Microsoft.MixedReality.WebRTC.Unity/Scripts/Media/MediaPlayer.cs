...
namespace Microsoft.MixedReality.WebRTC.Unity
{
    ...
    public class MediaPlayer : MonoBehaviour
    {
        ...
        private void CreateEmptyVideoTextures()
        {
            ...
            if (FrameQueue is VideoFrameQueue<I420VideoFrameStorage>)
            {
            ...
            else if (FrameQueue is VideoFrameQueue<ARGBVideoFrameStorage>)
            {
        ...
        private void TryProcessFrame()
        {
            ...
            else if (FrameQueue is VideoFrameQueue<ARGBVideoFrameStorage> argbQueue)
            {
                if (argbQueue.TryDequeue(out ARGBVideoFrameStorage frame))
                {
