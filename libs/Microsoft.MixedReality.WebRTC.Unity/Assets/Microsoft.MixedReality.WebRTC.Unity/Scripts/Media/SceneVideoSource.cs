...
namespace Microsoft.MixedReality.WebRTC.Unity
{
    ...
    /// </summary>
    public class SceneVideoSource : CustomVideoSource<ARGBVideoFrameStorage>
    {
        /// <summary>
        ...
        protected override void OnFrameRequested(FrameRequest request)
        {
            // Try to dequeue a frame from the internal frame queue
            if (FrameQueue is VideoFrameQueue<ARGBVideoFrameStorage> argbQueue) //< TODO - better abstraction
            {
                if (argbQueue.TryDequeue(out ARGBVideoFrameStorage storage))
                {
